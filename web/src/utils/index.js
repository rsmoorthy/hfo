...
export const materialFormStyles = {
  ...formStyles,
  textbox: {
    normal: { borderBottomColor: 'black', borderWidth: 0, marginBottom: 0, width: '80%' },
    error: { borderBottomColor: 'red', borderWidth: 0, borderBottomWidth: 3, marginBottom: 5, width: '80%' }
  },
  textboxView: {
    normal: { borderBottomColor: 'black', borderWidth: 0, borderRadius: 0, borderBottomWidth: 1, width: '80%' },
    error: { borderBottomColor: 'red', borderWidth: 0, borderRadius: 0, borderBottomWidth: 1, width: '80%' }
  }
}
